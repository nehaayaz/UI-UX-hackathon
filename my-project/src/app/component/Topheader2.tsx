      ...
      <div className="w-full h-[46px] bg-green-800 flex justify-between items-center px-4 sm:px-8">
        ...
        <div className="flex text-white items-center space-x-3 sm:space-x-5">
          <div className="flex items-center">
            ...
            <h6 className="font-bold text-[14px] leading-[24px] ml-2">(225) 555-0118</h6>
          </div>
          <div className="flex items-center space-x-2">
            <BiMessage className="text-white" />
            <h6 className="font-bold text-[14px] leading-[24px]">michelle.rivera@example.com</h6>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3 sm:space-x-5">
          <h6 className="text-white font-bold text-[14px] leading-[24px]">Follow Us: </h6>
